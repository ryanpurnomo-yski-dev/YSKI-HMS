...
new class extends Component
{
    ...
    {
        return view('components.pages.procurement_items_hms', [
            'items' => Barang::all(),
...
<div class="container-fluid px-0">
    <div class="mb-3">
        <h2 class="h4 mb-1">Form Pengadaan Barang</h2>
    </div>

    <div class="card border-1 shadow-sm">
        <div class="card-header bg-light border-bottom">
            <h3 class="h6 mb-1 fw-semibold">Form Pengadaan Barang</h3>
        </div>
        ...
        <div class="card-body p-3">
            ...
            @else 
            <form action="{{ route('items.post') }}" method="POST" class="row g-3">
                @csrf
                ...
                <div class="col-md-6">
                    <label class="form-label">Merk Barang</label>
                    <input type="text" class="form-control" name="merk_barang" placeholder="-- Masukkan Merk Barang --" required>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" name="kuantitas_barang" placeholder="Contoh: 10" required>
                </div>
